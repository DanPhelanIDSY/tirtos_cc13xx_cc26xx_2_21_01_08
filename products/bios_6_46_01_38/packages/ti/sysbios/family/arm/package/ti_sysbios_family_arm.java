...
public class ti_sysbios_family_arm
{
    ...
    void TaskSupport$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.TaskSupport.getCheckValueAddr", new Extern("ti_sysbios_family_arm_TaskSupport_getCheckValueAddr__E", "xdc_Ptr(*)(xdc_Ptr)", true, false));
    }
    ...
    void MPU$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_MPU_Module__startupDone__E", "ti_sysbios_family_arm_MPU_disable__E", "ti_sysbios_family_arm_MPU_enable__E", "ti_sysbios_family_arm_MPU_disableBR__E", "ti_sysbios_family_arm_MPU_enableBR__E", "ti_sysbios_family_arm_MPU_initRegionAttrs__E", "ti_sysbios_family_arm_MPU_isEnabled__E", "ti_sysbios_family_arm_MPU_setRegion__E", "ti_sysbios_family_arm_MPU_startup__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray("A_nullPointer", "A_invalidRegionId", "A_unalignedBaseAddr"));
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.setElem("", true);
        atmap.seal("length");
        vo.bind("MODULE_STARTUP$", 0);
