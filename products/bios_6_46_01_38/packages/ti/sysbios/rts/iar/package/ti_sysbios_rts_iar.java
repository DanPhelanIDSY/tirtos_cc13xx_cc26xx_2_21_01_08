...
public class ti_sysbios_rts_iar
{
    ...
    void MultithreadSupport$$TYPES()
    {
        ...
        if (isCFG) {
            po.addFld("enableMultithreadSupport", $$T_Bool, false, "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.rts.iar.arm3',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.rts.iar.arm3', {target: 'iar.targets.arm.M3', suffix: 'rm3'}],\n");
        sb.append("];\n");
