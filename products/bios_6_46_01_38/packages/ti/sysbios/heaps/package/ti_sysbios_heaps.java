...
public class ti_sysbios_heaps
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.aem3',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.am3g',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.arm3',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.am3g', {target: 'gnu.targets.arm.M3', suffix: 'm3g'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.arm3', {target: 'iar.targets.arm.M3', suffix: 'rm3'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void HeapBuf$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_heaps_HeapBuf_Handle__label__E", "ti_sysbios_heaps_HeapBuf_Module__startupDone__E", "ti_sysbios_heaps_HeapBuf_Object__create__E", "ti_sysbios_heaps_HeapBuf_Object__delete__E", "ti_sysbios_heaps_HeapBuf_Object__destruct__E", "ti_sysbios_heaps_HeapBuf_Object__get__E", "ti_sysbios_heaps_HeapBuf_Object__first__E", "ti_sysbios_heaps_HeapBuf_Object__next__E", "ti_sysbios_heaps_HeapBuf_Params__init__E", "ti_sysbios_heaps_HeapBuf_free__E", "ti_sysbios_heaps_HeapBuf_getStats__E", "ti_sysbios_heaps_HeapBuf_alloc__E", "ti_sysbios_heaps_HeapBuf_isBlocking__E", "ti_sysbios_heaps_HeapBuf_getBlockSize__E", "ti_sysbios_heaps_HeapBuf_getAlign__E", "ti_sysbios_heaps_HeapBuf_getEndAddr__E", "ti_sysbios_heaps_HeapBuf_getExtendedStats__E", "ti_sysbios_heaps_HeapBuf_mergeHeapBufs__E"));
    ...
    void HeapCallback$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_heaps_HeapCallback_Handle__label__E", "ti_sysbios_heaps_HeapCallback_Module__startupDone__E", "ti_sysbios_heaps_HeapCallback_Object__create__E", "ti_sysbios_heaps_HeapCallback_Object__delete__E", "ti_sysbios_heaps_HeapCallback_Object__destruct__E", "ti_sysbios_heaps_HeapCallback_Object__get__E", "ti_sysbios_heaps_HeapCallback_Object__first__E", "ti_sysbios_heaps_HeapCallback_Object__next__E", "ti_sysbios_heaps_HeapCallback_Params__init__E", "ti_sysbios_heaps_HeapCallback_alloc__E", "ti_sysbios_heaps_HeapCallback_free__E", "ti_sysbios_heaps_HeapCallback_isBlocking__E", "ti_sysbios_heaps_HeapCallback_getStats__E", "ti_sysbios_heaps_HeapCallback_getContext__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
