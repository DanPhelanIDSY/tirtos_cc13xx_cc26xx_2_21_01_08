...
public class ti_sysbios_productview
{
    ...
    void BiosProductView$$TYPES()
    {
        ...
        po.addFld("ti_sysbios_family_arm_cc26xx_Power", (Proto)om.findStrict("ti.sysbios.productview.BiosProductView.ProductElemDesc", "ti.sysbios.productview"), $$DEFAULT, "wh");
