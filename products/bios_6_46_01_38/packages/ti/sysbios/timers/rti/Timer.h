...
#define ti_sysbios_timers_rti_Timer___VERS 160
...
typedef ti_sysbios_timers_rti_Timer_TimerDevice *__ARRAY1_ti_sysbios_timers_rti_Timer_Module_State__device;
typedef __ARRAY1_ti_sysbios_timers_rti_Timer_Module_State__device __TA_ti_sysbios_timers_rti_Timer_Module_State__device;
typedef xdc_runtime_Types_FreqHz __T1_ti_sysbios_timers_rti_Timer_Module_State__intFreqs;
typedef xdc_runtime_Types_FreqHz *__ARRAY1_ti_sysbios_timers_rti_Timer_Module_State__intFreqs;
typedef __ARRAY1_ti_sysbios_timers_rti_Timer_Module_State__intFreqs __TA_ti_sysbios_timers_rti_Timer_Module_State__intFreqs;
typedef ti_sysbios_timers_rti_Timer_Handle __T1_ti_sysbios_timers_rti_Timer_Module_State__handles;
typedef ti_sysbios_timers_rti_Timer_Handle *__ARRAY1_ti_sysbios_timers_rti_Timer_Module_State__handles;
typedef __ARRAY1_ti_sysbios_timers_rti_Timer_Module_State__handles __TA_ti_sysbios_timers_rti_Timer_Module_State__handles;
...
typedef xdc_Bool (*CT__ti_sysbios_timers_rti_Timer_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__ti_sysbios_timers_rti_Timer_Module__startupDoneFxn ti_sysbios_timers_rti_Timer_Module__startupDoneFxn__C;
...
struct ti_sysbios_timers_rti_Timer_Struct {
    ...
    xdc_UInt __f7;
    xdc_UArg __f8;
    ti_sysbios_hal_Hwi_FuncPtr __f9;
    xdc_runtime_Types_FreqHz __f10;
    ti_sysbios_hal_Hwi_Handle __f11;
    xdc_Bool __f12;
...
struct ti_sysbios_timers_rti_Timer_Fxns__ {
    ...
    xdc_UInt32 (*getMaxTicks)(ti_sysbios_timers_rti_Timer_Handle);
    xdc_Void (*setNextTick)(ti_sysbios_timers_rti_Timer_Handle, xdc_UInt32);
    xdc_Void (*start)(ti_sysbios_timers_rti_Timer_Handle);
    xdc_Void (*stop)(ti_sysbios_timers_rti_Timer_Handle);
    xdc_Void (*setPeriod)(ti_sysbios_timers_rti_Timer_Handle, xdc_UInt32);
    xdc_Bool (*setPeriodMicroSecs)(ti_sysbios_timers_rti_Timer_Handle, xdc_UInt32);
    xdc_UInt32 (*getPeriod)(ti_sysbios_timers_rti_Timer_Handle);
    xdc_UInt32 (*getCount)(ti_sysbios_timers_rti_Timer_Handle);
    xdc_Void (*getFreq)(ti_sysbios_timers_rti_Timer_Handle, xdc_runtime_Types_FreqHz*);
    ti_sysbios_interfaces_ITimer_FuncPtr (*getFunc)(ti_sysbios_timers_rti_Timer_Handle, xdc_UArg*);
    xdc_Void (*setFunc)(ti_sysbios_timers_rti_Timer_Handle, ti_sysbios_interfaces_ITimer_FuncPtr, xdc_UArg);
    xdc_Void (*trigger)(ti_sysbios_timers_rti_Timer_Handle, xdc_UInt32);
    xdc_UInt32 (*getExpiredCounts)(ti_sysbios_timers_rti_Timer_Handle);
    xdc_UInt32 (*getExpiredTicks)(ti_sysbios_timers_rti_Timer_Handle, xdc_UInt32);
    xdc_UInt32 (*getCurrentTick)(ti_sysbios_timers_rti_Timer_Handle, xdc_Bool);
...
__extern xdc_Int ti_sysbios_timers_rti_Timer_Instance_init__E(ti_sysbios_timers_rti_Timer_Object *, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_timers_rti_Timer_Params *, xdc_runtime_Error_Block *);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_timers_rti_Timer_Instance_finalize__E, "ti_sysbios_timers_rti_Timer_Instance_finalize")
__extern void ti_sysbios_timers_rti_Timer_Instance_finalize__E( ti_sysbios_timers_rti_Timer_Object* , int );
...
__extern xdc_Ptr ti_sysbios_timers_rti_Timer_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );

/* create */
xdc__CODESECT(ti_sysbios_timers_rti_Timer_create, "ti_sysbios_timers_rti_Timer_create")
__extern ti_sysbios_timers_rti_Timer_Handle ti_sysbios_timers_rti_Timer_create( xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_timers_rti_Timer_Params *__prms, xdc_runtime_Error_Block *__eb );

/* construct */
xdc__CODESECT(ti_sysbios_timers_rti_Timer_construct, "ti_sysbios_timers_rti_Timer_construct")
__extern void ti_sysbios_timers_rti_Timer_construct( ti_sysbios_timers_rti_Timer_Struct *__obj, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_timers_rti_Timer_Params *__prms, xdc_runtime_Error_Block *__eb );
...
/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_timers_rti_Timer_Object__destruct__S, "ti_sysbios_timers_rti_Timer_Object__destruct__S")
__extern xdc_Void ti_sysbios_timers_rti_Timer_Object__destruct__S( xdc_Ptr objp );
...
static inline ti_sysbios_timers_rti_Timer_Handle ti_sysbios_timers_rti_Timer_Handle_downCast( ti_sysbios_interfaces_ITimer_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_sysbios_timers_rti_Timer_Module__FXNS__C ? (ti_sysbios_timers_rti_Timer_Handle)i : 0;
}
...
{
    return ti_sysbios_timers_rti_Timer_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sysbios_timers_rti_Timer_Module_getMask( void ) 
{
    return ti_sysbios_timers_rti_Timer_Module__diagsMask__C != NULL ? *ti_sysbios_timers_rti_Timer_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sysbios_timers_rti_Timer_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sysbios_timers_rti_Timer_Module__diagsMask__C != NULL) *ti_sysbios_timers_rti_Timer_Module__diagsMask__C = mask;
}
...
{
    if (prms) {
        ti_sysbios_timers_rti_Timer_Params__init__S(prms, 0, sizeof(ti_sysbios_timers_rti_Timer_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
