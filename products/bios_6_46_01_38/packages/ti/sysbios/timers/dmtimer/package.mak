...
override PKGDIR = ti/sysbios/timers/dmtimer
...
package/%.xdc.inc package/%_ti.sysbios.timers.dmtimer.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sysbios.timers.dmtimer" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sysbios.timers.dmtimer $@

.libraries,em3 .libraries: lib/sysbios/debug/ti.sysbios.timers.dmtimer.aem3

-include lib/sysbios/debug/ti.sysbios.timers.dmtimer.aem3.mak
lib/sysbios/debug/ti.sysbios.timers.dmtimer.aem3: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package/package_ti.sysbios.timers.dmtimer.oem3 package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer.oem3 package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer_asm.oem3 package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/TimestampProvider.oem3  into $@ ...
	$(ti.targets.arm.elf.M3.rootDir)/bin/armar  rq $@   package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package/package_ti.sysbios.timers.dmtimer.oem3 package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer.oem3 package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer_asm.oem3 package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/TimestampProvider.oem3 
lib/sysbios/debug/ti.sysbios.timers.dmtimer.aem3: export C_DIR=
lib/sysbios/debug/ti.sysbios.timers.dmtimer.aem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

clean,em3 clean::
	-$(RM) lib/sysbios/debug/ti.sysbios.timers.dmtimer.aem3
.libraries,m3g .libraries: lib/sysbios/debug/ti.sysbios.timers.dmtimer.am3g

-include lib/sysbios/debug/ti.sysbios.timers.dmtimer.am3g.mak
lib/sysbios/debug/ti.sysbios.timers.dmtimer.am3g: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package/package_ti.sysbios.timers.dmtimer.om3g package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer.om3g package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer_asm_gnu.om3g package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/TimestampProvider.om3g  into $@ ...
	$(gnu.targets.arm.M3.rootDir)/bin/arm-none-eabi-ar  cr $@   package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package/package_ti.sysbios.timers.dmtimer.om3g package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer.om3g package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer_asm_gnu.om3g package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/TimestampProvider.om3g 
lib/sysbios/debug/ti.sysbios.timers.dmtimer.am3g: export LD_LIBRARY_PATH=

clean,m3g clean::
	-$(RM) lib/sysbios/debug/ti.sysbios.timers.dmtimer.am3g
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
package_ti.sysbios.timers.dmtimer.oem3,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package/package_ti.sysbios.timers.dmtimer.oem3
package_ti.sysbios.timers.dmtimer.sem3,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package/package_ti.sysbios.timers.dmtimer.sem3
Timer.oem3,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer.oem3
Timer.sem3,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer.sem3
Timer_asm.oem3,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer_asm.oem3
TimestampProvider.oem3,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/TimestampProvider.oem3
TimestampProvider.sem3,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/TimestampProvider.sem3
package_ti.sysbios.timers.dmtimer.om3g,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package/package_ti.sysbios.timers.dmtimer.om3g
package_ti.sysbios.timers.dmtimer.sm3g,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package/package_ti.sysbios.timers.dmtimer.sm3g
Timer.om3g,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer.om3g
Timer.sm3g,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer.sm3g
Timer_asm_gnu.om3g,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/Timer_asm_gnu.om3g
TimestampProvider.om3g,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/TimestampProvider.om3g
TimestampProvider.sm3g,copy : package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/TimestampProvider.sm3g

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sysbios_timers_dmtimer
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sysbios_timers_dmtimer.tar.dep
-include package/rel/ti_sysbios_timers_dmtimer.tar.rcl.dep
endif
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: package/package.bld.xml
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: package/build.cfg
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: doc-files
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: package.bld
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: custom.mak
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: Timer.xml
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: TimestampProvider.xml
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: lib/sysbios/debug/ti.sysbios.timers.dmtimer.aem3
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: package/package_ti.sysbios.timers.dmtimer.c
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: Timer.c
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: Timer_asm.sv7M
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: TimestampProvider.c
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: lib/sysbios/debug/ti.sysbios.timers.dmtimer.am3g
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: Timer_asm_gnu.sv7M
package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_sysbios_timers_dmtimer.tar: package/rel/ti_sysbios_timers_dmtimer.xdc.inc package/rel/ti_sysbios_timers_dmtimer/ti/sysbios/timers/dmtimer/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sysbios_timers_dmtimer.xdc.inc,package/rel/ti_sysbios_timers_dmtimer.tar.dep, ti/sysbios/libFilter.xs)


release release,ti_sysbios_timers_dmtimer: all ti_sysbios_timers_dmtimer.tar
clean:: .clean
	-$(RM) ti_sysbios_timers_dmtimer.tar
	-$(RM) package/rel/ti_sysbios_timers_dmtimer.xdc.inc
	-$(RM) package/rel/ti_sysbios_timers_dmtimer.tar.dep
...
ifeq (,$(wildcard package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer))
    $(shell $(MKDIR) package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer)
endif
ifeq (,$(wildcard package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package))
    $(shell $(MKDIR) package/lib/lib/sysbios/debug/ti.sysbios.timers.dmtimer/package)
endif
endif
clean::
	-$(RMDIR) package
