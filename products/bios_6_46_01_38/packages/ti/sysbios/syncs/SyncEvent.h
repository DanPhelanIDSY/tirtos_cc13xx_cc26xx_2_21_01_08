...
#define ti_sysbios_syncs_SyncEvent___VERS 160
...
typedef xdc_Bool (*CT__ti_sysbios_syncs_SyncEvent_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__ti_sysbios_syncs_SyncEvent_Module__startupDoneFxn ti_sysbios_syncs_SyncEvent_Module__startupDoneFxn__C;
...
__extern xdc_Ptr ti_sysbios_syncs_SyncEvent_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );

/* create */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_create, "ti_sysbios_syncs_SyncEvent_create")
__extern ti_sysbios_syncs_SyncEvent_Handle ti_sysbios_syncs_SyncEvent_create( const ti_sysbios_syncs_SyncEvent_Params *__prms, xdc_runtime_Error_Block *__eb );

/* construct */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_construct, "ti_sysbios_syncs_SyncEvent_construct")
__extern void ti_sysbios_syncs_SyncEvent_construct( ti_sysbios_syncs_SyncEvent_Struct *__obj, const ti_sysbios_syncs_SyncEvent_Params *__prms );
...
/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Object__destruct__S, "ti_sysbios_syncs_SyncEvent_Object__destruct__S")
__extern xdc_Void ti_sysbios_syncs_SyncEvent_Object__destruct__S( xdc_Ptr objp );
...
__extern xdc_Bool ti_sysbios_syncs_SyncEvent_query__E( ti_sysbios_syncs_SyncEvent_Handle __inst, xdc_Int qual );
...
__extern xdc_Void ti_sysbios_syncs_SyncEvent_signal__E( ti_sysbios_syncs_SyncEvent_Handle __inst );
...
__extern xdc_Int ti_sysbios_syncs_SyncEvent_wait__E( ti_sysbios_syncs_SyncEvent_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block *eb );
...
static inline ti_sysbios_syncs_SyncEvent_Handle ti_sysbios_syncs_SyncEvent_Handle_downCast( xdc_runtime_knl_ISync_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_sysbios_syncs_SyncEvent_Module__FXNS__C ? (ti_sysbios_syncs_SyncEvent_Handle)i : 0;
}
...
{
    return ti_sysbios_syncs_SyncEvent_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sysbios_syncs_SyncEvent_Module_getMask( void ) 
{
    return ti_sysbios_syncs_SyncEvent_Module__diagsMask__C != NULL ? *ti_sysbios_syncs_SyncEvent_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sysbios_syncs_SyncEvent_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sysbios_syncs_SyncEvent_Module__diagsMask__C != NULL) *ti_sysbios_syncs_SyncEvent_Module__diagsMask__C = mask;
}
...
{
    if (prms) {
        ti_sysbios_syncs_SyncEvent_Params__init__S(prms, 0, sizeof(ti_sysbios_syncs_SyncEvent_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
