...
public class ti_sysbios
{
    ...
    void BIOS$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.BIOS.version", 0x64601L);
    ...
    void BIOS$$TYPES()
    {
        ...
        po.init("ti.sysbios.BIOS.Module", om.findStrict("xdc.runtime.IModule.Module", "ti.sysbios"));
                ...
                po.addFld("version", Proto.Elm.newCNum("(xdc_UInt32)"), 0x64601L, "rh");
        if (isCFG) {
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.aem3',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.am3g',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.arm3',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.am3g', {target: 'gnu.targets.arm.M3', suffix: 'm3g'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.arm3', {target: 'iar.targets.arm.M3', suffix: 'rm3'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
