...
public class ti_sysbios_gates
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.gates.aem3',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.gates.am3g',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.gates.arm3',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.gates.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.gates.am3g', {target: 'gnu.targets.arm.M3', suffix: 'm3g'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.gates.arm3', {target: 'iar.targets.arm.M3', suffix: 'rm3'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void GateHwi$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_gates_GateHwi_Handle__label__E", "ti_sysbios_gates_GateHwi_Module__startupDone__E", "ti_sysbios_gates_GateHwi_Object__create__E", "ti_sysbios_gates_GateHwi_Object__delete__E", "ti_sysbios_gates_GateHwi_Object__destruct__E", "ti_sysbios_gates_GateHwi_Object__get__E", "ti_sysbios_gates_GateHwi_Object__first__E", "ti_sysbios_gates_GateHwi_Object__next__E", "ti_sysbios_gates_GateHwi_Params__init__E", "ti_sysbios_gates_GateHwi_query__E", "ti_sysbios_gates_GateHwi_enter__E", "ti_sysbios_gates_GateHwi_leave__E"));
    ...
    void GateSwi$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_gates_GateSwi_Handle__label__E", "ti_sysbios_gates_GateSwi_Module__startupDone__E", "ti_sysbios_gates_GateSwi_Object__create__E", "ti_sysbios_gates_GateSwi_Object__delete__E", "ti_sysbios_gates_GateSwi_Object__destruct__E", "ti_sysbios_gates_GateSwi_Object__get__E", "ti_sysbios_gates_GateSwi_Object__first__E", "ti_sysbios_gates_GateSwi_Object__next__E", "ti_sysbios_gates_GateSwi_Params__init__E", "ti_sysbios_gates_GateSwi_query__E", "ti_sysbios_gates_GateSwi_enter__E", "ti_sysbios_gates_GateSwi_leave__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
    ...
    void GateTest$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_gates_GateTest_Handle__label__E", "ti_sysbios_gates_GateTest_Module__startupDone__E", "ti_sysbios_gates_GateTest_Object__create__E", "ti_sysbios_gates_GateTest_Object__delete__E", "ti_sysbios_gates_GateTest_Object__destruct__E", "ti_sysbios_gates_GateTest_Object__get__E", "ti_sysbios_gates_GateTest_Object__first__E", "ti_sysbios_gates_GateTest_Object__next__E", "ti_sysbios_gates_GateTest_Params__init__E", "ti_sysbios_gates_GateTest_query__E", "ti_sysbios_gates_GateTest_enter__E", "ti_sysbios_gates_GateTest_leave__E", "ti_sysbios_gates_GateTest_getEnterCount__E", "ti_sysbios_gates_GateTest_getLeaveCount__E", "ti_sysbios_gates_GateTest_getCreateCount__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
    ...
    void GateMutexPri$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_gates_GateMutexPri_Handle__label__E", "ti_sysbios_gates_GateMutexPri_Module__startupDone__E", "ti_sysbios_gates_GateMutexPri_Object__create__E", "ti_sysbios_gates_GateMutexPri_Object__delete__E", "ti_sysbios_gates_GateMutexPri_Object__destruct__E", "ti_sysbios_gates_GateMutexPri_Object__get__E", "ti_sysbios_gates_GateMutexPri_Object__first__E", "ti_sysbios_gates_GateMutexPri_Object__next__E", "ti_sysbios_gates_GateMutexPri_Params__init__E", "ti_sysbios_gates_GateMutexPri_query__E", "ti_sysbios_gates_GateMutexPri_enter__E", "ti_sysbios_gates_GateMutexPri_leave__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
