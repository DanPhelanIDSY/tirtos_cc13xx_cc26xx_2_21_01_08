...
public class ti_sysbios_xdcruntime
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.xdcruntime.aem3',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.xdcruntime.am3g',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.xdcruntime.arm3',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.xdcruntime.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.xdcruntime.am3g', {target: 'gnu.targets.arm.M3', suffix: 'm3g'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.xdcruntime.arm3', {target: 'iar.targets.arm.M3', suffix: 'rm3'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void GateProcessSupport$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_xdcruntime_GateProcessSupport_Handle__label__E", "ti_sysbios_xdcruntime_GateProcessSupport_Module__startupDone__E", "ti_sysbios_xdcruntime_GateProcessSupport_Object__create__E", "ti_sysbios_xdcruntime_GateProcessSupport_Object__delete__E", "ti_sysbios_xdcruntime_GateProcessSupport_Object__destruct__E", "ti_sysbios_xdcruntime_GateProcessSupport_Object__get__E", "ti_sysbios_xdcruntime_GateProcessSupport_Object__first__E", "ti_sysbios_xdcruntime_GateProcessSupport_Object__next__E", "ti_sysbios_xdcruntime_GateProcessSupport_Params__init__E", "ti_sysbios_xdcruntime_GateProcessSupport_query__E", "ti_sysbios_xdcruntime_GateProcessSupport_enter__E", "ti_sysbios_xdcruntime_GateProcessSupport_leave__E", "ti_sysbios_xdcruntime_GateProcessSupport_getReferenceCount__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
    ...
    void SemThreadSupport$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_xdcruntime_SemThreadSupport_Handle__label__E", "ti_sysbios_xdcruntime_SemThreadSupport_Module__startupDone__E", "ti_sysbios_xdcruntime_SemThreadSupport_Object__create__E", "ti_sysbios_xdcruntime_SemThreadSupport_Object__delete__E", "ti_sysbios_xdcruntime_SemThreadSupport_Object__destruct__E", "ti_sysbios_xdcruntime_SemThreadSupport_Object__get__E", "ti_sysbios_xdcruntime_SemThreadSupport_Object__first__E", "ti_sysbios_xdcruntime_SemThreadSupport_Object__next__E", "ti_sysbios_xdcruntime_SemThreadSupport_Params__init__E", "ti_sysbios_xdcruntime_SemThreadSupport_pend__E", "ti_sysbios_xdcruntime_SemThreadSupport_post__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
