...
override PKGDIR = ti/platforms/generic
...
package/%.xdc.inc package/%_ti.platforms.generic.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.platforms.generic" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.platforms.generic $@
...
.PHONY: release,ti_platforms_generic
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_platforms_generic.tar.dep
endif
package/rel/ti_platforms_generic/ti/platforms/generic/package/package.rel.xml: package/package.bld.xml
package/rel/ti_platforms_generic/ti/platforms/generic/package/package.rel.xml: package/build.cfg
package/rel/ti_platforms_generic/ti/platforms/generic/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_platforms_generic/ti/platforms/generic/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_platforms_generic/ti/platforms/generic/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_platforms_generic.tar: package/rel/ti_platforms_generic.xdc.inc package/rel/ti_platforms_generic/ti/platforms/generic/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_platforms_generic.xdc.inc,package/rel/ti_platforms_generic.tar.dep)


release release,ti_platforms_generic: all ti_platforms_generic.tar
clean:: .clean
	-$(RM) ti_platforms_generic.tar
	-$(RM) package/rel/ti_platforms_generic.xdc.inc
	-$(RM) package/rel/ti_platforms_generic.tar.dep
