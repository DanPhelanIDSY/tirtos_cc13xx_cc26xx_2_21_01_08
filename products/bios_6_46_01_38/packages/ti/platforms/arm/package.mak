...
override PKGDIR = ti/platforms/arm
...
package/%.xdc.inc package/%_ti.platforms.arm.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.platforms.arm" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.platforms.arm $@
...
.PHONY: release,ti_platforms_arm
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_platforms_arm.tar.dep
endif
package/rel/ti_platforms_arm/ti/platforms/arm/package/package.rel.xml: package/package.bld.xml
package/rel/ti_platforms_arm/ti/platforms/arm/package/package.rel.xml: package/build.cfg
package/rel/ti_platforms_arm/ti/platforms/arm/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_platforms_arm/ti/platforms/arm/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_platforms_arm/ti/platforms/arm/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_platforms_arm.tar: package/rel/ti_platforms_arm.xdc.inc package/rel/ti_platforms_arm/ti/platforms/arm/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_platforms_arm.xdc.inc,package/rel/ti_platforms_arm.tar.dep)


release release,ti_platforms_arm: all ti_platforms_arm.tar
clean:: .clean
	-$(RM) ti_platforms_arm.tar
	-$(RM) package/rel/ti_platforms_arm.xdc.inc
	-$(RM) package/rel/ti_platforms_arm.tar.dep
