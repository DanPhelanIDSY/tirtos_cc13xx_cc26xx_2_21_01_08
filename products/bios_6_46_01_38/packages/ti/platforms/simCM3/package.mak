...
override PKGDIR = ti/platforms/simCM3
...
package/%.xdc.inc package/%_ti.platforms.simCM3.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.platforms.simCM3" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.platforms.simCM3 $@
...
.PHONY: release,ti_platforms_simCM3
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_platforms_simCM3.tar.dep
endif
package/rel/ti_platforms_simCM3/ti/platforms/simCM3/package/package.rel.xml: package/package.bld.xml
package/rel/ti_platforms_simCM3/ti/platforms/simCM3/package/package.rel.xml: package/build.cfg
package/rel/ti_platforms_simCM3/ti/platforms/simCM3/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_platforms_simCM3/ti/platforms/simCM3/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_platforms_simCM3/ti/platforms/simCM3/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_platforms_simCM3.tar: package/rel/ti_platforms_simCM3.xdc.inc package/rel/ti_platforms_simCM3/ti/platforms/simCM3/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_platforms_simCM3.xdc.inc,package/rel/ti_platforms_simCM3.tar.dep)


release release,ti_platforms_simCM3: all ti_platforms_simCM3.tar
clean:: .clean
	-$(RM) ti_platforms_simCM3.tar
	-$(RM) package/rel/ti_platforms_simCM3.xdc.inc
	-$(RM) package/rel/ti_platforms_simCM3.tar.dep
