...
override PKGDIR = ti/catalog/arm
...
package/%.xdc.inc package/%_ti.catalog.arm.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.catalog.arm" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.catalog.arm $@
...
.PHONY: release,ti_catalog_arm
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_catalog_arm.tar.dep
endif
package/rel/ti_catalog_arm/ti/catalog/arm/package/package.rel.xml: package/package.bld.xml
package/rel/ti_catalog_arm/ti/catalog/arm/package/package.rel.xml: package/build.cfg
package/rel/ti_catalog_arm/ti/catalog/arm/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_catalog_arm/ti/catalog/arm/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_catalog_arm/ti/catalog/arm/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_catalog_arm.tar: package/rel/ti_catalog_arm.xdc.inc package/rel/ti_catalog_arm/ti/catalog/arm/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_catalog_arm.xdc.inc,package/rel/ti_catalog_arm.tar.dep)


release release,ti_catalog_arm: all ti_catalog_arm.tar
clean:: .clean
	-$(RM) ti_catalog_arm.tar
	-$(RM) package/rel/ti_catalog_arm.xdc.inc
	-$(RM) package/rel/ti_catalog_arm.tar.dep
