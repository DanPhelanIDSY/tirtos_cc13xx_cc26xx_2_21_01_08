...
override PKGDIR = ti/targets/arm/elf
...
package/%.xdc.inc package/%_ti.targets.arm.elf.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.targets.arm.elf" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.targets.arm.elf $@
...
.PHONY: release,ti_targets_arm_elf
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_targets_arm_elf.tar.dep
endif
package/rel/ti_targets_arm_elf/ti/targets/arm/elf/package/package.rel.xml: package/package.bld.xml
package/rel/ti_targets_arm_elf/ti/targets/arm/elf/package/package.rel.xml: package/build.cfg
package/rel/ti_targets_arm_elf/ti/targets/arm/elf/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_targets_arm_elf/ti/targets/arm/elf/package/package.rel.xml: linkcmd.xdt
package/rel/ti_targets_arm_elf/ti/targets/arm/elf/package/package.rel.xml: linkUtils.xs
package/rel/ti_targets_arm_elf/ti/targets/arm/elf/package/package.rel.xml: std.h
package/rel/ti_targets_arm_elf/ti/targets/arm/elf/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_targets_arm_elf/ti/targets/arm/elf/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_targets_arm_elf.tar: package/rel/ti_targets_arm_elf.xdc.inc package/rel/ti_targets_arm_elf/ti/targets/arm/elf/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_targets_arm_elf.xdc.inc,package/rel/ti_targets_arm_elf.tar.dep)


release release,ti_targets_arm_elf: all ti_targets_arm_elf.tar
clean:: .clean
	-$(RM) ti_targets_arm_elf.tar
	-$(RM) package/rel/ti_targets_arm_elf.xdc.inc
	-$(RM) package/rel/ti_targets_arm_elf.tar.dep
