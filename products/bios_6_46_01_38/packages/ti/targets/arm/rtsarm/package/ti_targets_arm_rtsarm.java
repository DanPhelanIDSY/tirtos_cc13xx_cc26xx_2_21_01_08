...
public class ti_targets_arm_rtsarm
{
    ...
    void Settings$$OBJECTS()
    {
        ...
        po = (Proto.Obj)om.bind("ti.targets.arm.rtsarm.Settings.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("ti.targets.arm.rtsarm.Settings", new Value.Obj("ti.targets.arm.rtsarm.Settings", po));
    ...
    void Settings$$TYPES()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.targets.arm.rtsarm.Settings.Module", "ti.targets.arm.rtsarm");
        po.init("ti.targets.arm.rtsarm.Settings.Module", om.findStrict("xdc.runtime.IModule.Module", "ti.targets.arm.rtsarm"));
    ...
    void Settings$$ROV()
    {
        ...
        vo = (Value.Obj)om.findStrict("ti.targets.arm.rtsarm.Settings", "ti.targets.arm.rtsarm");
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.targets.arm.rtsarm$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.targets.arm.rtsarm$$stat$base'];\n");
    ...
    void Settings$$SINGLETONS()
    {
        ...
        vo = (Value.Obj)om.findStrict("ti.targets.arm.rtsarm.Settings", "ti.targets.arm.rtsarm");
        po = (Proto.Obj)om.findStrict("ti.targets.arm.rtsarm.Settings.Module", "ti.targets.arm.rtsarm");
        vo.init2(po, "ti.targets.arm.rtsarm.Settings", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", $$UNDEF);
        vo.bind("$package", om.findStrict("ti.targets.arm.rtsarm", "ti.targets.arm.rtsarm"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
        icfgs.clear();
        ...
        ((Value.Arr)om.findStrict("$modules", "ti.targets.arm.rtsarm")).add(vo);
        vo.bind("$$instflag", 0);
        vo.bind("$$iobjflag", 0);
        vo.bind("$$sizeflag", 1);
        vo.bind("$$dlgflag", 0);
        ...
        vo.bind("$$fxntab", Global.newArray("ti_targets_arm_rtsarm_Settings_Module__startupDone__E"));
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("ti.targets.arm.rtsarm.Settings", "ti.targets.arm.rtsarm"));
        Global.callFxn("init", pkgV);
        ((Value.Obj)om.getv("ti.targets.arm.rtsarm.Settings")).bless();
