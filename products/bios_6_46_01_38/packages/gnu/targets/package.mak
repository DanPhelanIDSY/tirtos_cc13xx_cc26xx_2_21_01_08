...
package.mak: _utils.xs
package.mak: Linux86.xs
package.mak: Mingw.xs
...
package/%.xdc.inc package/%_gnu.targets.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package gnu.targets" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js gnu.targets $@
...
.PHONY: release,gnu_targets
ifeq (,$(MK_NOGENDEPS))
-include package/rel/gnu_targets.tar.dep
endif
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: package/package.bld.xml
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: package/build.cfg
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: package/package.xdc.inc
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: runh
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: linkcmd.xdt
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: linkUtils.xs
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: std.h
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: _utils.xs
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/gnu_targets/gnu/targets/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

gnu_targets.tar: package/rel/gnu_targets.xdc.inc package/rel/gnu_targets/gnu/targets/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/gnu_targets.xdc.inc,package/rel/gnu_targets.tar.dep)


release release,gnu_targets: all gnu_targets.tar
clean:: .clean
	-$(RM) gnu_targets.tar
	-$(RM) package/rel/gnu_targets.xdc.inc
	-$(RM) package/rel/gnu_targets.tar.dep
