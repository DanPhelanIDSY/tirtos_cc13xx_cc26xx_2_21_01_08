...
public class gnu_targets_arm_rtsv7M
{
    ...
    void Settings$$OBJECTS()
    {
        ...
        po = (Proto.Obj)om.bind("gnu.targets.arm.rtsv7M.Settings.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("gnu.targets.arm.rtsv7M.Settings", new Value.Obj("gnu.targets.arm.rtsv7M.Settings", po));
    ...
    void Settings$$TYPES()
    {
        ...
        po = (Proto.Obj)om.findStrict("gnu.targets.arm.rtsv7M.Settings.Module", "gnu.targets.arm.rtsv7M");
        po.init("gnu.targets.arm.rtsv7M.Settings.Module", om.findStrict("xdc.runtime.IModule.Module", "gnu.targets.arm.rtsv7M"));
    ...
    void Settings$$ROV()
    {
        ...
        vo = (Value.Obj)om.findStrict("gnu.targets.arm.rtsv7M.Settings", "gnu.targets.arm.rtsv7M");
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('gnu.targets.arm.rtsv7M$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['gnu.targets.arm.rtsv7M$$stat$base'];\n");
    ...
    void Settings$$SINGLETONS()
    {
        ...
        vo = (Value.Obj)om.findStrict("gnu.targets.arm.rtsv7M.Settings", "gnu.targets.arm.rtsv7M");
        po = (Proto.Obj)om.findStrict("gnu.targets.arm.rtsv7M.Settings.Module", "gnu.targets.arm.rtsv7M");
        vo.init2(po, "gnu.targets.arm.rtsv7M.Settings", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", $$UNDEF);
        vo.bind("$package", om.findStrict("gnu.targets.arm.rtsv7M", "gnu.targets.arm.rtsv7M"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
        icfgs.clear();
        ...
        ((Value.Arr)om.findStrict("$modules", "gnu.targets.arm.rtsv7M")).add(vo);
        vo.bind("$$instflag", 0);
        vo.bind("$$iobjflag", 0);
        vo.bind("$$sizeflag", 1);
        vo.bind("$$dlgflag", 0);
        ...
        vo.bind("$$fxntab", Global.newArray("gnu_targets_arm_rtsv7M_Settings_Module__startupDone__E"));
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("gnu.targets.arm.rtsv7M.Settings", "gnu.targets.arm.rtsv7M"));
        Global.callFxn("init", pkgV);
        ((Value.Obj)om.getv("gnu.targets.arm.rtsv7M.Settings")).bless();
