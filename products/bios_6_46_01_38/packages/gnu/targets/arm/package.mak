...
override PKGDIR = gnu/targets/arm
...
package.mak: GCArmv6.xs
package.mak: GCArmv7A.xs
package.mak: IM.xs
package.mak: M3.xs
package.mak: M4.xs
package.mak: M4F.xs
...
package/%.xdc.inc package/%_gnu.targets.arm.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package gnu.targets.arm" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js gnu.targets.arm $@
...
.PHONY: release,gnu_targets_arm
ifeq (,$(MK_NOGENDEPS))
-include package/rel/gnu_targets_arm.tar.dep
endif
package/rel/gnu_targets_arm/gnu/targets/arm/package/package.rel.xml: package/package.bld.xml
package/rel/gnu_targets_arm/gnu/targets/arm/package/package.rel.xml: package/build.cfg
package/rel/gnu_targets_arm/gnu/targets/arm/package/package.rel.xml: package/package.xdc.inc
package/rel/gnu_targets_arm/gnu/targets/arm/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/gnu_targets_arm/gnu/targets/arm/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

gnu_targets_arm.tar: package/rel/gnu_targets_arm.xdc.inc package/rel/gnu_targets_arm/gnu/targets/arm/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/gnu_targets_arm.xdc.inc,package/rel/gnu_targets_arm.tar.dep)


release release,gnu_targets_arm: all gnu_targets_arm.tar
clean:: .clean
	-$(RM) gnu_targets_arm.tar
	-$(RM) package/rel/gnu_targets_arm.xdc.inc
	-$(RM) package/rel/gnu_targets_arm.tar.dep
