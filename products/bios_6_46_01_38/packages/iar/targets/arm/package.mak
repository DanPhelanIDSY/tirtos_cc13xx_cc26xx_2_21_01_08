...
override PKGDIR = iar/targets/arm
...
package/%.xdc.inc package/%_iar.targets.arm.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package iar.targets.arm" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js iar.targets.arm $@
...
.PHONY: release,iar_targets_arm
ifeq (,$(MK_NOGENDEPS))
-include package/rel/iar_targets_arm.tar.dep
endif
package/rel/iar_targets_arm/iar/targets/arm/package/package.rel.xml: package/package.bld.xml
package/rel/iar_targets_arm/iar/targets/arm/package/package.rel.xml: package/build.cfg
package/rel/iar_targets_arm/iar/targets/arm/package/package.rel.xml: package/package.xdc.inc
package/rel/iar_targets_arm/iar/targets/arm/package/package.rel.xml: std.h
package/rel/iar_targets_arm/iar/targets/arm/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/iar_targets_arm/iar/targets/arm/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

iar_targets_arm.tar: package/rel/iar_targets_arm.xdc.inc package/rel/iar_targets_arm/iar/targets/arm/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/iar_targets_arm.xdc.inc,package/rel/iar_targets_arm.tar.dep)


release release,iar_targets_arm: all iar_targets_arm.tar
clean:: .clean
	-$(RM) iar_targets_arm.tar
	-$(RM) package/rel/iar_targets_arm.xdc.inc
	-$(RM) package/rel/iar_targets_arm.tar.dep
