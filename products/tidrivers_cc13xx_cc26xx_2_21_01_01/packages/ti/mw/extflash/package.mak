...
override PKGDIR = ti/mw/extflash
...
package/%.xdc.inc package/%_ti.mw.extflash.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.mw.extflash" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.mw.extflash $@
...
.PHONY: release,ti_mw_extflash
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_mw_extflash.zip.dep
endif
package/rel/ti_mw_extflash/ti/mw/extflash/package/package.rel.xml: package/package.bld.xml
package/rel/ti_mw_extflash/ti/mw/extflash/package/package.rel.xml: package/build.cfg
package/rel/ti_mw_extflash/ti/mw/extflash/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_mw_extflash/ti/mw/extflash/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_mw_extflash/ti/mw/extflash/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

../../../../exports/ti_mw_extflash.zip: package/rel/ti_mw_extflash.xdc.inc package/rel/ti_mw_extflash/ti/mw/extflash/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/ti_mw_extflash.xdc.inc,package/rel/ti_mw_extflash.zip.dep)


release release,ti_mw_extflash: all ../../../../exports/ti_mw_extflash.zip
clean:: .clean
	-$(RM) package/rel/ti_mw_extflash.xdc.inc
	-$(RM) package/rel/ti_mw_extflash.zip.dep
