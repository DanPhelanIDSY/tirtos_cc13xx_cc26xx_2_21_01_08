...
package/%.xdc.inc package/%_ti.mw.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.mw" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.mw $@
...
.PHONY: release,ti_mw
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_mw.zip.dep
endif
package/rel/ti_mw/ti/mw/package/package.rel.xml: package/package.bld.xml
package/rel/ti_mw/ti/mw/package/package.rel.xml: package/build.cfg
package/rel/ti_mw/ti/mw/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_mw/ti/mw/package/package.rel.xml: package.bld
package/rel/ti_mw/ti/mw/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_mw/ti/mw/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

../../../exports/ti_mw.zip: package/rel/ti_mw.xdc.inc package/rel/ti_mw/ti/mw/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/ti_mw.xdc.inc,package/rel/ti_mw.zip.dep)


release release,ti_mw: all ../../../exports/ti_mw.zip
clean:: .clean
	-$(RM) package/rel/ti_mw.xdc.inc
	-$(RM) package/rel/ti_mw.zip.dep
