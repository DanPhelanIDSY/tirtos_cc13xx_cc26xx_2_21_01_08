...
\index{Power.\+h@{Power.\+h}!Power\+\_\+disable\+Policy@{Power\+\_\+disable\+Policy}}
\index{Power\+\_\+disable\+Policy@{Power\+\_\+disable\+Policy}!Power.\+h@{Power.\+h}}
\paragraph[{Power\+\_\+disable\+Policy}]{\setlength{\rightskip}{0pt plus 5cm}void Power\+\_\+disable\+Policy (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)}\label{_power_8h_ab0cdc171229c9f0d075c993f2b06ced0}


Disable the configured power policy from running when the C\+P\+U is idle. 

Calling this function clears the flag that controls whether the configured power policy function is invoked on each pass through the Idle loop. This function call will override both a \textquotesingle{}true\textquotesingle{} setting of the \char`\"{}enable\+Policy\char`\"{} setting in the Power manager configuration object, as well as a previous runtime call to the \hyperlink{_power_8h_ae8d6092a8fb35b6db52a69a35fcc327f}{Power\+\_\+enable\+Policy()} function.

\begin{DoxySeeAlso}{See also}
\hyperlink{_power_8h_ae8d6092a8fb35b6db52a69a35fcc327f}{Power\+\_\+enable\+Policy} 
\end{DoxySeeAlso}
...
Calling this function sets a flag that will cause the configured power policy function to be invoked on each pass through the Idle loop. This function call will override both a \textquotesingle{}false\textquotesingle{} setting of the \char`\"{}enable\+Policy\char`\"{} setting in the Power manager configuration object, as well as a previous runtime call to the \hyperlink{_power_8h_ab0cdc171229c9f0d075c993f2b06ced0}{Power\+\_\+disable\+Policy()} function.
...
\begin{DoxySeeAlso}{See also}
\hyperlink{_power_8h_ab0cdc171229c9f0d075c993f2b06ced0}{Power\+\_\+disable\+Policy} 
\end{DoxySeeAlso}
\index{Power.\+h@{Power.\+h}!Power\+\_\+get\+Constraint\+Mask@{Power\+\_\+get\+Constraint\+Mask}}
...
Constraint identifiers are device specific, and defined in the device-\/specific Power include file. For example, the constraints for M\+S\+P432 are defined in Power\+M\+S\+P432.\+h. The corresponding bit in the bitmask returned by this function can be derived by a left-\/shift using the constraint identifier. For example, for M\+S\+P432, for the corresponding bit for the Power\+M\+S\+P432\+\_\+\+D\+I\+S\+A\+L\+L\+O\+W\+\_\+\+S\+L\+E\+E\+P constraint, the bit position is determined by the operation\+: (1 $<$$<$ Power\+M\+S\+P432\+\_\+\+D\+I\+S\+A\+L\+L\+O\+W\+\_\+\+S\+L\+E\+E\+P)
...
Resource identifiers are device specific, and defined in the device-\/specific Power include file. For example, the resources for C\+C3200 are defined in Power\+C\+C3200.\+h.
...
Sleep states are device specific, and defined in the device-\/specific Power include file. For example, the sleep states for C\+C3200 are defined in Power\+C\+C3200.\+h.
...
Constraint identifiers are device specific, and defined in the device-\/specific Power include file. For example, the constraints for M\+S\+P432 are defined in Power\+M\+S\+P432.\+h.
...
\end{DoxySeeAlso}
\index{Power.\+h@{Power.\+h}!Power\+\_\+set\+Policy@{Power\+\_\+set\+Policy}}
\index{Power\+\_\+set\+Policy@{Power\+\_\+set\+Policy}!Power.\+h@{Power.\+h}}
\paragraph[{Power\+\_\+set\+Policy}]{\setlength{\rightskip}{0pt plus 5cm}void Power\+\_\+set\+Policy (
\begin{DoxyParamCaption}
\item[{{\bf Power\+\_\+\+Policy\+Fxn}}]{policy}
\end{DoxyParamCaption}
)}\label{_power_8h_aa4af0d238813058bf6146df6021df8cc}
...
\begin{DoxyParams}{Parameters}
{\em policy} & the new Power policy function \\
\hline
\end{DoxyParams}
