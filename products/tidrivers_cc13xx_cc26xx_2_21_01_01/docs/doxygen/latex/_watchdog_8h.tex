...
\index{Watchdog.\+h@{Watchdog.\+h}!Watchdog\+\_\+\+Convert\+Ms\+To\+Ticks\+Fxn@{Watchdog\+\_\+\+Convert\+Ms\+To\+Ticks\+Fxn}}
\index{Watchdog\+\_\+\+Convert\+Ms\+To\+Ticks\+Fxn@{Watchdog\+\_\+\+Convert\+Ms\+To\+Ticks\+Fxn}!Watchdog.\+h@{Watchdog.\+h}}
\paragraph[{Watchdog\+\_\+\+Convert\+Ms\+To\+Ticks\+Fxn}]{\setlength{\rightskip}{0pt plus 5cm}typedef uint32\+\_\+t($\ast$ Watchdog\+\_\+\+Convert\+Ms\+To\+Ticks\+Fxn) (uint32\+\_\+t milliseconds)}\label{_watchdog_8h_aaf90926e5dc22cdca706b9aa86ee7580}
...
{\em handle} & Watchdog Handle\\
\hline
{\em ticks} & Value to be loaded into Watchdog timer Unit is in Watchdog clock ticks \\
\hline
\end{DoxyParams}
\index{Watchdog.\+h@{Watchdog.\+h}!Watchdog\+\_\+convert\+Ms\+To\+Ticks@{Watchdog\+\_\+convert\+Ms\+To\+Ticks}}
\index{Watchdog\+\_\+convert\+Ms\+To\+Ticks@{Watchdog\+\_\+convert\+Ms\+To\+Ticks}!Watchdog.\+h@{Watchdog.\+h}}
\paragraph[{Watchdog\+\_\+convert\+Ms\+To\+Ticks}]{\setlength{\rightskip}{0pt plus 5cm}uint32\+\_\+t Watchdog\+\_\+convert\+Ms\+To\+Ticks (
\begin{DoxyParamCaption}
\item[{{\bf Watchdog\+\_\+\+Handle}}]{handle, }
\item[{uint32\+\_\+t}]{milliseconds}
\end{DoxyParamCaption}
)}\label{_watchdog_8h_a7b93cd0bd3a6f11aa28b0c7219755979}


Converts milliseconds to Watchdog clock ticks. 

Converts the input value into number of Watchdog clock ticks as close as possible. If the converted value exceeds 32 bits, a zero (0) will be returned to indicate overflow. The converted value can be used as the function parameter \textquotesingle{}ticks\textquotesingle{} in \hyperlink{_watchdog_8h_a476ef7b9d4e7268717adf94d8505f4a5}{Watchdog\+\_\+set\+Reload()}.
...
{\em handle} & Watchdog Handle\\
\hline
{\em milliseconds} & Value to be converted\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyReturn}
\begin{DoxySeeAlso}{See also}
\hyperlink{_watchdog_8h_a476ef7b9d4e7268717adf94d8505f4a5}{Watchdog\+\_\+set\+Reload()} 
\end{DoxySeeAlso}
