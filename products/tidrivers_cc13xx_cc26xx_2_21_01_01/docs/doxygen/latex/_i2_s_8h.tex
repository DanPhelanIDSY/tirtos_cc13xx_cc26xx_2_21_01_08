...
\index{I2\+S.\+h@{I2\+S.\+h}!I2\+S\+\_\+\+E\+R\+R\+O\+R@{I2\+S\+\_\+\+E\+R\+R\+O\+R}}
...
Commands for I2\+S\+\_\+control can originate from \hyperlink{_i2_s_8h}{I2\+S.\+h} or from implementation specific I2\+S$\ast$.h ({\itshape I2\+S\+C\+C3200.\+h}, etc.. ) files. While commands from \hyperlink{_i2_s_8h}{I2\+S.\+h} are A\+P\+I portable across driver implementations, not all implementations may support all these commands. Conversely, commands from driver implementation specific I2\+S$\ast$.h files add unique driver capabilities but are not A\+P\+I portable across all I2\+S driver implementations.

Commands supported by \hyperlink{_i2_s_8h}{I2\+S.\+h} follow a I2\+S\+\_\+\+C\+M\+D\+\_\+$<$cmd$>$ naming convention.~\newline
 Commands supported by I2\+S$\ast$.h follow a I2\+S$\ast$\+\_\+\+C\+M\+D\+\_\+$<$cmd$>$ naming convention.~\newline
 Each control command defines {\bfseries arg} differently. The types of {\bfseries arg} are documented with each command.

See \hyperlink{group___i2_s___c_m_d}{I2\+S\+\_\+control command codes} for command codes.

See \hyperlink{group___i2_s___s_t_a_t_u_s}{I2\+S\+\_\+control return status codes} for status codes.
...
\hline
{\em cmd} & \hyperlink{_i2_s_8h}{I2\+S.\+h} or I2\+S$\ast$.h commands.\\
\hline
