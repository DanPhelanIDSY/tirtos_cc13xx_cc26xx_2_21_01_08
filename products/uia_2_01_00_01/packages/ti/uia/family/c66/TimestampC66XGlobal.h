...
#define ti_uia_family_c66_TimestampC66XGlobal___VERS 160
...
typedef xdc_Bool (*CT__ti_uia_family_c66_TimestampC66XGlobal_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__ti_uia_family_c66_TimestampC66XGlobal_Module__startupDoneFxn ti_uia_family_c66_TimestampC66XGlobal_Module__startupDoneFxn__C;
...
__extern xdc_Void ti_uia_family_c66_TimestampC66XGlobal_Instance_init__E(ti_uia_family_c66_TimestampC66XGlobal_Object *, const ti_uia_family_c66_TimestampC66XGlobal_Params *);
...
__extern xdc_Ptr ti_uia_family_c66_TimestampC66XGlobal_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );

/* create */
xdc__CODESECT(ti_uia_family_c66_TimestampC66XGlobal_create, "ti_uia_family_c66_TimestampC66XGlobal_create")
__extern ti_uia_family_c66_TimestampC66XGlobal_Handle ti_uia_family_c66_TimestampC66XGlobal_create( const ti_uia_family_c66_TimestampC66XGlobal_Params *__prms, xdc_runtime_Error_Block *__eb );

/* construct */
xdc__CODESECT(ti_uia_family_c66_TimestampC66XGlobal_construct, "ti_uia_family_c66_TimestampC66XGlobal_construct")
__extern void ti_uia_family_c66_TimestampC66XGlobal_construct( ti_uia_family_c66_TimestampC66XGlobal_Struct *__obj, const ti_uia_family_c66_TimestampC66XGlobal_Params *__prms );
...
/* Object__destruct__S */
xdc__CODESECT(ti_uia_family_c66_TimestampC66XGlobal_Object__destruct__S, "ti_uia_family_c66_TimestampC66XGlobal_Object__destruct__S")
__extern xdc_Void ti_uia_family_c66_TimestampC66XGlobal_Object__destruct__S( xdc_Ptr objp );
...
{
    return ti_uia_family_c66_TimestampC66XGlobal_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_uia_family_c66_TimestampC66XGlobal_Module_getMask( void ) 
{
    return ti_uia_family_c66_TimestampC66XGlobal_Module__diagsMask__C != NULL ? *ti_uia_family_c66_TimestampC66XGlobal_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_uia_family_c66_TimestampC66XGlobal_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_uia_family_c66_TimestampC66XGlobal_Module__diagsMask__C != NULL) *ti_uia_family_c66_TimestampC66XGlobal_Module__diagsMask__C = mask;
}
...
{
    if (prms) {
        ti_uia_family_c66_TimestampC66XGlobal_Params__init__S(prms, 0, sizeof(ti_uia_family_c66_TimestampC66XGlobal_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
