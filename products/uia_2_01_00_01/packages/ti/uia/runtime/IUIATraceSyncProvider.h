...
#define ti_uia_runtime_IUIATraceSyncProvider___VERS 160
...
/* injectIntoTrace */
static inline xdc_Void ti_uia_runtime_IUIATraceSyncProvider_injectIntoTrace( ti_uia_runtime_IUIATraceSyncProvider_Module __inst, xdc_UInt32 serialNum, ti_uia_runtime_IUIATraceSyncProvider_ContextType ctxType )
{
    __inst->injectIntoTrace(serialNum, ctxType);
}
...
static inline ti_uia_runtime_IUIATraceSyncProvider_injectIntoTrace_FxnT ti_uia_runtime_IUIATraceSyncProvider_injectIntoTrace_fxnP( ti_uia_runtime_IUIATraceSyncProvider_Module __inst )
{
    return (ti_uia_runtime_IUIATraceSyncProvider_injectIntoTrace_FxnT)__inst->injectIntoTrace;
}
...
static inline ti_uia_runtime_IUIATraceSyncProvider_Module ti_uia_runtime_IUIATraceSyncProvider_Module_downCast( ti_uia_events_IUIAMetaProvider_Module m )
{
    xdc_runtime_Types_Base* b; for (b = m->__base; b; b = b->base) {
        if (b == &ti_uia_runtime_IUIATraceSyncProvider_Interface__BASE__C) return (ti_uia_runtime_IUIATraceSyncProvider_Module)m;
    } return 0;
}
