...
#define ti_uia_runtime_ILoggerSnapshot___VERS 160
...
static inline ti_uia_runtime_ILoggerSnapshot_Module ti_uia_runtime_ILoggerSnapshot_Module_downCast( ti_uia_runtime_IUIATransfer_Module m )
{
    xdc_runtime_Types_Base* b; for (b = m->__base; b; b = b->base) {
        if (b == &ti_uia_runtime_ILoggerSnapshot_Interface__BASE__C) return (ti_uia_runtime_ILoggerSnapshot_Module)m;
    } return 0;
}
...
static inline ti_uia_runtime_ILoggerSnapshot_Handle ti_uia_runtime_ILoggerSnapshot_Handle_downCast( ti_uia_runtime_IUIATransfer_Handle i )
{
    ...
    xdc_runtime_Types_Base* b; for (b = i2->__fxns->__base; b; b = b->base) {
        if (b == &ti_uia_runtime_ILoggerSnapshot_Interface__BASE__C) return (ti_uia_runtime_ILoggerSnapshot_Handle)i;
    } return 0;
}
