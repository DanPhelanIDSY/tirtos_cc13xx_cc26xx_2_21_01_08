...
#define ti_uia_runtime_IUIATraceSyncClient___VERS 160
...
static inline ti_uia_runtime_IUIATraceSyncClient_Module ti_uia_runtime_IUIATraceSyncClient_Module_downCast( ti_uia_events_IUIAMetaProvider_Module m )
{
    xdc_runtime_Types_Base* b; for (b = m->__base; b; b = b->base) {
        if (b == &ti_uia_runtime_IUIATraceSyncClient_Interface__BASE__C) return (ti_uia_runtime_IUIATraceSyncClient_Module)m;
    } return 0;
}
