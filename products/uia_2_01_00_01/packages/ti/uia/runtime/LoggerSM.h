...
#define ti_uia_runtime_LoggerSM___VERS 160
...
typedef xdc_Bool (*CT__ti_uia_runtime_LoggerSM_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__ti_uia_runtime_LoggerSM_Module__startupDoneFxn ti_uia_runtime_LoggerSM_Module__startupDoneFxn__C;
...
struct ti_uia_runtime_LoggerSM_Fxns__ {
    ...
    xdc_Bool (*enable)(ti_uia_runtime_LoggerSM_Handle);
    xdc_Bool (*disable)(ti_uia_runtime_LoggerSM_Handle);
    xdc_Void (*write0)(ti_uia_runtime_LoggerSM_Handle, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId);
    xdc_Void (*write1)(ti_uia_runtime_LoggerSM_Handle, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg);
    xdc_Void (*write2)(ti_uia_runtime_LoggerSM_Handle, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg);
    xdc_Void (*write4)(ti_uia_runtime_LoggerSM_Handle, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
    xdc_Void (*write8)(ti_uia_runtime_LoggerSM_Handle, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
    xdc_Void (*setFilterLevel)(ti_uia_runtime_LoggerSM_Handle, xdc_runtime_Diags_Mask, xdc_runtime_Diags_EventLevel);
    xdc_runtime_Diags_Mask (*getFilterLevel)(ti_uia_runtime_LoggerSM_Handle, xdc_runtime_Diags_EventLevel);
...
__extern xdc_Void ti_uia_runtime_LoggerSM_Instance_init__E(ti_uia_runtime_LoggerSM_Object *, const ti_uia_runtime_LoggerSM_Params *);
...
__extern xdc_Ptr ti_uia_runtime_LoggerSM_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
/* Object__destruct__S */
xdc__CODESECT(ti_uia_runtime_LoggerSM_Object__destruct__S, "ti_uia_runtime_LoggerSM_Object__destruct__S")
__extern xdc_Void ti_uia_runtime_LoggerSM_Object__destruct__S( xdc_Ptr objp );
...
static inline ti_uia_runtime_LoggerSM_Handle ti_uia_runtime_LoggerSM_Handle_downCast( xdc_runtime_IFilterLogger_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_uia_runtime_LoggerSM_Module__FXNS__C ? (ti_uia_runtime_LoggerSM_Handle)i : 0;
}
...
{
    return ti_uia_runtime_LoggerSM_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_uia_runtime_LoggerSM_Module_getMask( void ) 
{
    return ti_uia_runtime_LoggerSM_Module__diagsMask__C != NULL ? *ti_uia_runtime_LoggerSM_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_uia_runtime_LoggerSM_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_uia_runtime_LoggerSM_Module__diagsMask__C != NULL) *ti_uia_runtime_LoggerSM_Module__diagsMask__C = mask;
}
