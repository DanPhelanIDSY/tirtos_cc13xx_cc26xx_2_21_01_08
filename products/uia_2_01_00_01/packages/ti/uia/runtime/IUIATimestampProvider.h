...
#define ti_uia_runtime_IUIATimestampProvider___VERS 160
...
/* get32 */
static inline xdc_Bits32 ti_uia_runtime_IUIATimestampProvider_get32( ti_uia_runtime_IUIATimestampProvider_Module __inst )
{
    return __inst->get32();
}

/* get64 */
static inline xdc_Void ti_uia_runtime_IUIATimestampProvider_get64( ti_uia_runtime_IUIATimestampProvider_Module __inst, xdc_runtime_Types_Timestamp64 *result )
{
    __inst->get64(result);
}

/* getFreq */
static inline xdc_Void ti_uia_runtime_IUIATimestampProvider_getFreq( ti_uia_runtime_IUIATimestampProvider_Module __inst, xdc_runtime_Types_FreqHz *freq )
{
    __inst->getFreq(freq);
}
...
static inline ti_uia_runtime_IUIATimestampProvider_get32_FxnT ti_uia_runtime_IUIATimestampProvider_get32_fxnP( ti_uia_runtime_IUIATimestampProvider_Module __inst )
{
    return (ti_uia_runtime_IUIATimestampProvider_get32_FxnT)__inst->get32;
}

/* get64_{FxnT,fxnP} */
typedef xdc_Void (*ti_uia_runtime_IUIATimestampProvider_get64_FxnT)(xdc_runtime_Types_Timestamp64*);
static inline ti_uia_runtime_IUIATimestampProvider_get64_FxnT ti_uia_runtime_IUIATimestampProvider_get64_fxnP( ti_uia_runtime_IUIATimestampProvider_Module __inst )
{
    return (ti_uia_runtime_IUIATimestampProvider_get64_FxnT)__inst->get64;
}

/* getFreq_{FxnT,fxnP} */
typedef xdc_Void (*ti_uia_runtime_IUIATimestampProvider_getFreq_FxnT)(xdc_runtime_Types_FreqHz*);
static inline ti_uia_runtime_IUIATimestampProvider_getFreq_FxnT ti_uia_runtime_IUIATimestampProvider_getFreq_fxnP( ti_uia_runtime_IUIATimestampProvider_Module __inst )
{
    return (ti_uia_runtime_IUIATimestampProvider_getFreq_FxnT)__inst->getFreq;
}
...
static inline ti_uia_runtime_IUIATimestampProvider_Module ti_uia_runtime_IUIATimestampProvider_Module_downCast( xdc_runtime_ITimestampProvider_Module m )
{
    xdc_runtime_Types_Base* b; for (b = m->__base; b; b = b->base) {
        if (b == &ti_uia_runtime_IUIATimestampProvider_Interface__BASE__C) return (ti_uia_runtime_IUIATimestampProvider_Module)m;
    } return 0;
}
