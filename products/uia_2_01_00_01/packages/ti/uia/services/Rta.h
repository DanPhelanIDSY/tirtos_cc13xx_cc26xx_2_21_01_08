...
#define ti_uia_services_Rta___VERS 160
...
typedef ti_uia_runtime_IUIATransfer_Handle *__ARRAY1_ti_uia_services_Rta_Module_State__loggers;
typedef __ARRAY1_ti_uia_services_Rta_Module_State__loggers __TA_ti_uia_services_Rta_Module_State__loggers;
...
typedef xdc_Bool (*CT__ti_uia_services_Rta_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__ti_uia_services_Rta_Module__startupDoneFxn ti_uia_services_Rta_Module__startupDoneFxn__C;
...
{
    return ti_uia_services_Rta_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_uia_services_Rta_Module_getMask( void ) 
{
    return ti_uia_services_Rta_Module__diagsMask__C != NULL ? *ti_uia_services_Rta_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_uia_services_Rta_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_uia_services_Rta_Module__diagsMask__C != NULL) *ti_uia_services_Rta_Module__diagsMask__C = mask;
}
