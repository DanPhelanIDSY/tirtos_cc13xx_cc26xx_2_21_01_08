...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x0078, 0x007D, 0x00BB, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000,
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x7007, 0x14BC, 0x7001, 0x14C9, 0xADB7, 0x7004, 0x14CD, 0x70BC,
    /*0x0100*/ 0x6007, 0x14D5, 0x705D, 0x6003, 0x14D5, 0x7041, 0x1462, 0xFB4D, 0x8609, 0x7101, 0x6431, 0x2531, 0xA6FE, 0xFB00, 0x7018, 0xFB4C,
    /*0x0120*/ 0x7003, 0xFB4C, 0xFD47, 0xFB4C, 0x1465, 0x6403, 0x001F, 0x8B2C, 0xFDB1, 0x8902, 0x0C75, 0x14DB, 0x7004, 0x14E4, 0xDD40, 0x6873,
    /*0x0140*/ 0xDD06, 0x6876, 0xDD2E, 0xB604, 0x14EC, 0x5000, 0x5C77, 0x04AB, 0x5877, 0xD801, 0x5C77, 0x5874, 0xDA00, 0xB607, 0x5877, 0x6874,
    /*0x0160*/ 0xDD2E, 0xAE03, 0x14EC, 0x5000, 0x5C77, 0x5873, 0x8D05, 0x0C76, 0x7001, 0x14C9, 0xADB7, 0xADB7, 0xF007, 0x1462, 0x86FF, 0x63F8,
    /*0x0180*/ 0xEB51, 0x8680, 0x6000, 0xED8F, 0xEB49, 0xFD47, 0xEB49, 0x1465, 0xADB7, 0x686B, 0xE867, 0xFF2E, 0xADB7, 0xED47, 0xEDAB, 0xE814,
    /*0x01A0*/ 0xF007, 0x5001, 0xDD87, 0xDF26, 0xADB7, 0xFB0C, 0xEDA4, 0xEB09, 0x640B, 0xCDB1, 0xADB7, 0x1462, 0x7079, 0xFB55, 0x71FB, 0xFB54,
    /*0x01C0*/ 0x1465, 0x4431, 0x4400, 0xADB7, 0xED47, 0xEDAB, 0xE816, 0xF007, 0x5001, 0xDD87, 0xDF26, 0xADB7, 0x786B, 0x6001, 0xED87, 0x786C,
    /*0x01E0*/ 0xFD0E, 0x7C6C, 0xADB7
};
...
//  cfg         input       output      state
    0x020100E6, 0x00000000, 0x010100EA, 0x020100EC  // ADC Sample
};
...
static void scifTaskResourceInit(void) {
    ...
    scifInitIo(4, AUXIOMODE_OUTPUT, -1, 0);
