...
public class examples
{
    ...
    void TrexExamples$$OBJECTS()
    {
        ...
        om.bind("examples.TrexExamples.Board", om.findStrict("xdc.tools.product.IProductTemplate.Board", "examples"));
    ...
    void TrexExamples$$SINGLETONS()
    {
        ...
        vo.bind("Board", om.findStrict("xdc.tools.product.IProductTemplate.Board", "examples"));
        tdefs.add(om.findStrict("xdc.tools.product.IProductTemplate.Board", "examples"));
